package org.fundaciobit.queesticfent.persistence.test;
...
import org.fundaciobit.queesticfent.persistence.queesticfentJPADaoManagers;
import org.fundaciobit.queesticfent.model.queesticfentDaoManager;
...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
            ...
            IPluginManager pluginMan = queesticfentDaoManager.getDaoManagers().getPluginManager();
            ...
            */
             ...
             * IIdiomaManager idioma = queesticfentDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        prop.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost:5432/queesticfent");
        prop.put("javax.persistence.jdbc.user", "queesticfent");
        prop.put("javax.persistence.jdbc.password", "queesticfent");

        prop.put("hibernate.connection.driver_class", "org.postgresql.Driver");
        prop.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/queesticfent");
        prop.put("hibernate.connection.username", "queesticfent");
        prop.put("hibernate.connection.password", "queesticfent");
        ...
        emf = Persistence.createEntityManagerFactory("queesticfentPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        queesticfentDaoManager.setDaoManagers(new queesticfentJPADaoManagers(em)); 
