package org.fundaciobit.queesticfent.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.queesticfent.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.queesticfent.",""), v.toString());
