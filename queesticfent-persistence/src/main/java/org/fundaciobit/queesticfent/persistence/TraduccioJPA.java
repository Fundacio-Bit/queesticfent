...
@Table(name = "qef_traduccio" , indexes = { 
        @Index(name="qef_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="qef_traduccio_seq", allocationSize=1, initialValue=1000)
...
public class TraduccioJPA implements Traduccio {
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = org.fundaciobit.queesticfent.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="qef_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="qef_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, org.fundaciobit.queesticfent.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.queesticfent.persistence.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.queesticfent.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.queesticfent.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.queesticfent.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.queesticfent.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.queesticfent.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
