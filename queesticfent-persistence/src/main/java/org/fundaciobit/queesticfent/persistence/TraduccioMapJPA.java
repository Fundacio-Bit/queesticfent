...
@Table(name = "qef_traducciomap" , indexes = { 
        @Index(name="qef_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="qef_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
