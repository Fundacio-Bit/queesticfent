 ...
 * @author anadal
 */
public class EntradesValidator<I extends Entrades>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements EntradesFields {

    protected final Logger log = Logger.getLogger(getClass());


  public EntradesValidator() {
    super();    
  }
