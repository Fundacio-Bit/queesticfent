...
public class FitxerBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.queesticfent.model.dao.IFitxerManager __fitxerManager;


  public final FitxerValidator<FitxerJPA> _validator;


  public FitxerBeanValidator(org.fundaciobit.queesticfent.model.dao.IFitxerManager __fitxerManager) { 
  ...
  public FitxerBeanValidator(FitxerValidator<FitxerJPA> _validator,
     org.fundaciobit.queesticfent.model.dao.IFitxerManager __fitxerManager) {
    this.__fitxerManager = __fitxerManager;
