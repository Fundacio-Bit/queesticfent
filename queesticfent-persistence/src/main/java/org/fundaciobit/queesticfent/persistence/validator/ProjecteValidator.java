 ...
 * @author anadal
 */
public class ProjecteValidator<I extends Projecte>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements ProjecteFields {

    protected final Logger log = Logger.getLogger(getClass());


  public ProjecteValidator() {
    super();    
  }
