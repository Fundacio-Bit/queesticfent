...
@Table(name = "qef_fitxer" , indexes = { 
        @Index(name="qef_fitxer_pk_i", columnList = "fitxerid")})
@SequenceGenerator(name="FITXER_SEQ", sequenceName="qef_fitxer_seq", allocationSize=1, initialValue=1000)
...
public class FitxerJPA implements Fitxer {
  ...
  void postLoad() {
    if (threadLocal.get() != null) {
      this.encryptedFileID = org.fundaciobit.queesticfent.hibernate.HibernateFileUtil.encryptFileID(fitxerID);
    }
  }
