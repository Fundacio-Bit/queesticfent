...
@Table(name = "qef_idioma" , indexes = { 
        @Index(name="qef_idioma_pk_i", columnList = "idiomaid")})
@SequenceGenerator(name="IDIOMA_SEQ", sequenceName="qef_idioma_seq", allocationSize=1, initialValue=1000)
