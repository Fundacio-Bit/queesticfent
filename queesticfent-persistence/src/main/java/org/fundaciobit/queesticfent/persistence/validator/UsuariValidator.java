  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(USUARIID) == 0) {
        java.lang.String __usuariid = __target__.getUsuariID();
        Long __count_ = null;
        try { __count_ = __usuariManager.count(org.fundaciobit.genapp.common.query.Where.AND(USUARIID.equal(__usuariid))); } catch(org.fundaciobit.genapp.common.i18n.I18NException e) { e.printStackTrace(); };
