 ...
 * @author anadal
 */
public class AccioValidator<I extends Accio>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements AccioFields {

    protected final Logger log = Logger.getLogger(getClass());


  public AccioValidator() {
    super();    
  }
