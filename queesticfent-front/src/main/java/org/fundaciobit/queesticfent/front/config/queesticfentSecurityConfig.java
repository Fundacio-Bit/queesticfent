...
@EnableWebSecurity
@Profile("!https")
@ComponentScan(basePackages = { "org.fundaciobit.queesticfent.front", "org.fundaciobit.pluginsib.login.springutils" })
public class queesticfentSecurityConfig extends WebSecurityConfigurerAdapter {
