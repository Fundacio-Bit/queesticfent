...
@OpenAPIDefinition(
        ...
        servers = {
                @Server(url = "/queesticfentapi/externa"),
                @Server(url = "http://localhost:8080/queesticfentapi/externa"),
                @Server(url = "https://dev.caib.es/queesticfentapi/externa"),
                @Server(url = "https://proves.caib.es/queesticfentapi/externa"),
                @Server(url = "https://se.caib.es/queesticfentapi/externa"),
                @Server(url = "https://www.caib.es/queesticfentapi/externa") },
...
public class JAXRSConfiguration extends Application {
    ...
    @PostConstruct
    private void init() {
        log.info("Iniciant API REST EXTERNA de queesticfent");
    }
