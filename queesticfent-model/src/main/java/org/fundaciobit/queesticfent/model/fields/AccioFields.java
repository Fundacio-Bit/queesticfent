...
public interface AccioFields extends java.io.Serializable {

  public static final String _TABLE_SQL = "qef_accio";


  public static final String _TABLE_MODEL = "accio";
  ...
  public static final Field<?>[] ALL_ACCIO_FIELDS = {
    ACCIOID,
    NOM,
    NOMLLEGENDA,
    COLOR,
