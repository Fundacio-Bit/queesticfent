...
public interface ModificacioQueEsticFentFields extends java.io.Serializable {

  public static final String _TABLE_SQL = "qef_modificacioqueesticfent";


  public static final String _TABLE_MODEL = "modificacioQueEsticFent";
  ...
  public static final Field<?>[] ALL_MODIFICACIOQUEESTICFENT_FIELDS = {
    MODIFICACIOID,
    ACCIOID,
    USUARIID,
    PROJECTEID,
