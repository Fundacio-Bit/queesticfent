...
public interface ProjecteFields extends java.io.Serializable {

  public static final String _TABLE_SQL = "qef_projecte";


  public static final String _TABLE_MODEL = "projecte";
  ...
  public static final Field<?>[] ALL_PROJECTE_FIELDS = {
    PROJECTEID,
    NOM,
    DEPARTAMENTID,
    DESCRIPCIO,
