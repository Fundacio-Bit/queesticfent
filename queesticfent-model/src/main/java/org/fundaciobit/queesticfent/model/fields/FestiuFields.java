...
public interface FestiuFields extends java.io.Serializable {

  public static final String _TABLE_SQL = "qef_festiu";


  public static final String _TABLE_MODEL = "festiu";
  ...
  public static final Field<?>[] ALL_FESTIU_FIELDS = {
    FESTIUID,
    NOM,
    DATA,
    DESCRIPCIO
