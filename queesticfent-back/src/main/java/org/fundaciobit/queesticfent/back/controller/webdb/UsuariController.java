...
import org.fundaciobit.queesticfent.back.validator.webdb.UsuariWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="usuari.usuari.plural", order=110, group="WEBDB")
@Controller
@RequestMapping(value = "/webdb/usuari")
@SessionAttributes(types = { UsuariForm.class, UsuariFilterForm.class })
public class UsuariController
    extends org.fundaciobit.queesticfent.back.controller.queesticfentBaseController<Usuari, java.lang.String> implements UsuariFields {
  ...
  public ModelAndView veureUsuariGet(@PathVariable("usuariID") java.lang.String usuariID,
  ...
  protected ModelAndView editAndViewUsuariGet(@PathVariable("usuariID") java.lang.String usuariID,
      HttpServletRequest request,
  ...
  public ModelAndView editarUsuariGet(@PathVariable("usuariID") java.lang.String usuariID,
      HttpServletRequest request,
      HttpServletResponse response) throws I18NException {
      return editAndViewUsuariGet(usuariID,
  ...
  public String eliminarUsuari(@PathVariable("usuariID") java.lang.String usuariID,
      HttpServletRequest request,HttpServletResponse response) {
...
public java.lang.String stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String cancelUsuari(@PathVariable("usuariID") java.lang.String usuariID,
      HttpServletRequest request,HttpServletResponse response) {
  ...
  public UsuariJPA findByPrimaryKey(HttpServletRequest request, java.lang.String usuariID) throws I18NException {
