 ...
 * 
 */
public class queesticfentMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof queesticfentMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof queesticfentMaxUploadSizeExceededException) {
          msgCode = ((queesticfentMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
