...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Projectes
   */
  @RequestMapping(value = "/cancel")
  public String cancelProjectes(HttpServletRequest request,HttpServletResponse response) {
