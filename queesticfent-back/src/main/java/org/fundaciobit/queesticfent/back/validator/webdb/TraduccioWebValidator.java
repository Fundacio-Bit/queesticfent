...
import org.fundaciobit.queesticfent.persistence.validator.TraduccioValidator;
...
public class TraduccioWebValidator extends AbstractWebValidator<TraduccioForm, Traduccio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.queesticfent.ejb.TraduccioService.JNDI_NAME)
