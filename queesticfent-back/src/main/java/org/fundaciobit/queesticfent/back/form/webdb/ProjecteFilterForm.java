 ...
 */
@Component
public class ProjecteFilterForm extends queesticfentBaseFilterForm implements ProjecteFields {
  ...
  public ProjecteFilterForm() {
  }
  
  public ProjecteFilterForm(ProjecteFilterForm __toClone) {
    super(__toClone);
