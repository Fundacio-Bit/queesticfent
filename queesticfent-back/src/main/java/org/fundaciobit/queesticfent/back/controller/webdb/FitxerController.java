...
import org.fundaciobit.queesticfent.back.form.webdb.FitxerForm;

import org.fundaciobit.queesticfent.back.validator.webdb.FitxerWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="fitxer.fitxer.plural", order=40, group="WEBDB")
@Controller
...
public class FitxerController
    extends org.fundaciobit.queesticfent.back.controller.queesticfentBaseController<Fitxer, java.lang.Long> implements FitxerFields {

  @EJB(mappedName = org.fundaciobit.queesticfent.ejb.FitxerService.JNDI_NAME)
  protected org.fundaciobit.queesticfent.ejb.FitxerService fitxerEjb;
