...
import org.fundaciobit.queesticfent.hibernate.HibernateFileUtil;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            if (fd == null) {
                throw new Exception("No s'ha definit la propietat de la ubicació dels fitxers ("
                        +  "org.fundaciobit.queesticfent.filesdirectory)") ;
            }
            if (!fd.exists()) {
        ...
        try {
            ...
            String[] basenames = { "missatges", // /WEB-INF/classes/
                    "logicmissatges", "genapp", "queesticfent_genapp" };
            ...
            if (plugins == null || plugins.size() == 0) {
                ...
                for (Class<? extends IExportDataPlugin> class1 : plugins) {
                    ...
                    if (edp == null) {
                        ...
                        DataExporterManager.addDataExporter(new org.fundaciobit.queesticfent.back.utils.queesticfentDataExporter(edp));
                    }
                }
            }
        ...
        try {
            log.info("queesticfent Version: " + ver);
        } catch (Throwable e) {
            log.info("queesticfent Version: " + ver);
        }
            ...
            public void run() {
                try {
                    MenuOptionManager.setDiscoverMenuOptionAnnotations(
                            new DiscoverMenuOptionAnnotations(Constants.QUEESTICFENT_PROPERTY_BASE + "back.controller"));
                } catch (Throwable th) {
