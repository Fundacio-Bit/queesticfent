...
import org.fundaciobit.queesticfent.ejb.TraduccioService;
import org.fundaciobit.genapp.common.i18n.I18NException;
import org.fundaciobit.queesticfent.model.fields.TraduccioFields;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    List<org.fundaciobit.queesticfent.model.entity.Traduccio> traduccions = traduccioEjb.select(where);
    ...
    for (org.fundaciobit.queesticfent.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.queesticfent.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.queesticfent.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.queesticfent.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
