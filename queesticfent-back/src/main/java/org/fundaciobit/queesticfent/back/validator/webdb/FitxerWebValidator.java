...
import org.fundaciobit.queesticfent.persistence.validator.FitxerValidator;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.queesticfent.ejb.FitxerService.JNDI_NAME)
