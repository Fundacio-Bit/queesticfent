 ...
 *
 */
public class queesticfentSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.queesticfent.commons.utils.Configuracio.getDefaultLanguage();
			}
