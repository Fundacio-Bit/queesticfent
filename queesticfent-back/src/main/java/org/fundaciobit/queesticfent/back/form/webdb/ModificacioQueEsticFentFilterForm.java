 ...
 */
@Component
public class ModificacioQueEsticFentFilterForm extends queesticfentBaseFilterForm implements ModificacioQueEsticFentFields {
  ...
  public ModificacioQueEsticFentFilterForm() {
  }
  
  public ModificacioQueEsticFentFilterForm(ModificacioQueEsticFentFilterForm __toClone) {
    super(__toClone);
