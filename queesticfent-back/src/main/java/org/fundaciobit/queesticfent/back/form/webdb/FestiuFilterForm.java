 ...
 */
@Component
public class FestiuFilterForm extends queesticfentBaseFilterForm implements FestiuFields {
  ...
  public FestiuFilterForm() {
  }
  
  public FestiuFilterForm(FestiuFilterForm __toClone) {
    super(__toClone);
