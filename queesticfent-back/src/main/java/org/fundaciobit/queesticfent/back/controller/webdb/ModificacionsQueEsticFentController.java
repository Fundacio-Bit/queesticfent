...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de ModificacionsQueEsticFent
   */
  @RequestMapping(value = "/cancel")
  public String cancelModificacionsQueEsticFent(HttpServletRequest request,HttpServletResponse response) {
