...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PersonalProjecte
   */
  @RequestMapping(value = "/cancel")
  public String cancelPersonalProjecte(HttpServletRequest request,HttpServletResponse response) {
