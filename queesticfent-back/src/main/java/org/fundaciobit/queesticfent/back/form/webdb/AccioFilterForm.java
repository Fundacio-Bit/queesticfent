 ...
 */
@Component
public class AccioFilterForm extends queesticfentBaseFilterForm implements AccioFields {
  ...
  public AccioFilterForm() {
  }
  
  public AccioFilterForm(AccioFilterForm __toClone) {
    super(__toClone);
