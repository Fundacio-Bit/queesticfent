 ...
 */
@Controller
public abstract class queesticfentFilesBaseController<I extends IGenAppEntity,PK extends Object,F extends BaseForm> extends CommonFilesBaseController<I,PK,F,Fitxer>{
	...
	getFilesFormManager() {
    return new queesticfentFilesFormManager(fitxerEjb);
  }
