...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de UsuarisDepartament
   */
  @RequestMapping(value = "/cancel")
  public String cancelUsuarisDepartament(HttpServletRequest request,HttpServletResponse response) {
