...
import org.fundaciobit.queesticfent.back.form.webdb.TraduccioForm;

import org.fundaciobit.queesticfent.back.validator.webdb.TraduccioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="traduccio.traduccio.plural", order=90, group="WEBDB")
@Controller
...
public class TraduccioController
    extends org.fundaciobit.queesticfent.back.controller.queesticfentBaseController<Traduccio, java.lang.Long> implements TraduccioFields {

  @EJB(mappedName = org.fundaciobit.queesticfent.ejb.TraduccioService.JNDI_NAME)
  protected org.fundaciobit.queesticfent.ejb.TraduccioService traduccioEjb;
