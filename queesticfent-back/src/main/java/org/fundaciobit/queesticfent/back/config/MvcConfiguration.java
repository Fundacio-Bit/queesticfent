package org.fundaciobit.queesticfent.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.queesticfent"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new org.fundaciobit.queesticfent.back.utils.queesticfentSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.queesticfent.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new org.fundaciobit.queesticfent.back.utils.queesticfentCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new org.fundaciobit.queesticfent.back.utils.queesticfentMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/queesticfent_genapp", "/WEB-INF/classes/genapp");
