...
<c:if test="${modificacioQueEsticFentForm.nou}">

    // Si es nou posam el darrer projecte seleccionat

    $(document).ready(
            function() {
                document.getElementById('modificacioQueEsticFent_projecteID_columnvalueid').innerHTML += document
    ...
    function setCategoria(categoria) {
        ...
        document.getElementById("modificacioQueEsticFent_projecteID").value = projecteID;
    }
    ...
    $("#modificacioQueEsticFentForm").on("submit", function(event) {
        
        var combo = document.getElementById("modificacioQueEsticFent_projecteID");
