...
<un:useConstants var="ProjecteFields" className="org.fundaciobit.queesticfent.model.fields.ProjecteFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.PROJECTEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="projecte.projecteID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="projecte.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.DEPARTAMENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="projecte.departamentID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="projecte.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.ACTIU)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="projecte.actiu" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.FROMDATA)}">
            <%-- FILTRE DATE --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="projecte.fromdata" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ProjecteFields.TODATA)}">
            <%-- FILTRE DATE --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="projecte.todata" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
            <div class="form-group"  style="margin-bottom: 0px;" >
