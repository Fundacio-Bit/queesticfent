...
<un:useConstants var="DepartamentFields" className="org.fundaciobit.queesticfent.model.fields.DepartamentFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DepartamentFields.COORDINADORID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="departament.coordinadorid" var="coordinadorid" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DepartamentFields.NOMLDAP)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="departament.nomldap" var="nomldap" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DepartamentFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="departament.descripcio" var="descripcio" />
