...
<%-- FILTRE DATE-TIME --%>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacionsQueEsticFentFields.DADA1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modificacionsQueEsticFent.dada1" var="dada1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacionsQueEsticFentFields.DADA2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modificacionsQueEsticFent.dada2" var="dada2" />
