...
<un:useConstants var="UsuariDepartamentFields" className="org.fundaciobit.queesticfent.model.fields.UsuariDepartamentFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariDepartamentFields.USUARIID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuariDepartament.usuariID" var="usuariID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariDepartamentFields.DEPARTAMENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="usuariDepartament.departamentID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariDepartamentFields.USUARIDEPARTAMENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="usuariDepartament.usuaridepartamentID" />:</span>
