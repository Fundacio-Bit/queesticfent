...
<un:useConstants var="ModificacioQueEsticFentFields" className="org.fundaciobit.queesticfent.model.fields.ModificacioQueEsticFentFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.MODIFICACIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="modificacioQueEsticFent.modificacioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.ACCIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="modificacioQueEsticFent.accioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.USUARIID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modificacioQueEsticFent.usuariID" var="usuariID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.PROJECTEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="modificacioQueEsticFent.projecteID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.QUEESTICFENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="modificacioQueEsticFent.queEsticFentID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.DADA1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modificacioQueEsticFent.dada1" var="dada1" />
              <fmt:message key="genapp.form.searchby" var="cercaperdada1" >                
                 <fmt:param value="${dada1}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${dada1}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperdada1}" path="dada1" />
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.DADA2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="modificacioQueEsticFent.dada2" var="dada2" />
              <fmt:message key="genapp.form.searchby" var="cercaperdada2" >                
                 <fmt:param value="${dada2}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${dada2}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperdada2}" path="dada2" />
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ModificacioQueEsticFentFields.DATA)}">
<%-- FILTRE DATE-TIME --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="modificacioQueEsticFent.data" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
