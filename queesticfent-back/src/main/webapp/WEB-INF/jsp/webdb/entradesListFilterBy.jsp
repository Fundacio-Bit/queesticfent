...
<un:useConstants var="EntradesFields" className="org.fundaciobit.queesticfent.model.fields.EntradesFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.ENTRADAID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrades.entradaID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.ACCIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrades.accioid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.USUARIID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrades.usuariid" var="usuariid" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.PROJECTEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrades.projecteid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.QUEESTICFENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrades.queesticfentid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.DADA1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrades.dada1" var="dada1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.DADA2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrades.dada2" var="dada2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradesFields.DATA)}">
            <%-- FILTRE TIME --%>      
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="entrades.data" />:</span>
