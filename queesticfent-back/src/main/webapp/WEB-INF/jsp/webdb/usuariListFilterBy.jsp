      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.USUARIID)}">
            ...
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.usuariID" var="usuariID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.EXTENSIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.extensio" var="extensio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.NAIXEMENT)}">
            <%-- FILTRE DATE --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="usuari.naixement" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.TELEFONCASA)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.telefoncasa" var="telefoncasa" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.TELEFONMOBIL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.telefonmobil" var="telefonmobil" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,UsuariFields.CONTRASENYA)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="usuari.contrasenya" var="contrasenya" />
