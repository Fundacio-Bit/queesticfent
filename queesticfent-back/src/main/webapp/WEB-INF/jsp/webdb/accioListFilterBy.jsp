...
<un:useConstants var="AccioFields" className="org.fundaciobit.queesticfent.model.fields.AccioFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccioFields.ACCIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="accio.accioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccioFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accio.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccioFields.NOMLLEGENDA)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accio.nomllegenda" var="nomllegenda" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccioFields.COLOR)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accio.color" var="color" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccioFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accio.descripcio" var="descripcio" />
