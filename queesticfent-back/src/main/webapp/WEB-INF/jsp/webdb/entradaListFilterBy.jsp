...
<un:useConstants var="EntradaFields" className="org.fundaciobit.queesticfent.model.fields.EntradaFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.ENTRADAID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrada.entradaID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.ACCIOID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrada.accioID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.USUARIID)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrada.usuariID" var="usuariID" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.PROJECTEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrada.projecteID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.DADA1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrada.dada1" var="dada1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.QUEESTICFENTID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entrada.queEsticFentID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.DADA2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entrada.dada2" var="dada2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntradaFields.DATA)}">
<%-- FILTRE DATE-TIME --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="entrada.data" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
