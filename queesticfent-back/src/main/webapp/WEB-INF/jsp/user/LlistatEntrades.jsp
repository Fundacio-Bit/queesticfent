...
<body>
 ...
 %>
                                            ...
                                            <%-- /* DEPARTAMENTS   */  --%>
                                            <td align="left"
                                                style="border-left: 1px solid; padding-right: 10px; padding-left: 10px;">
                                                <%
                                                if (model.getDepartaments().size() == 1) {
                                                %> <input type="hidden" name="departamentID" value="<%=model.getDepartamentId()%>"> Departament:<br> <b>
                                                    <%=model.getDepartamentsInfo().get(0).getNom()%></b> <%
 } else {
 %> Departaments:<br> <select name="departamentID" onchange="document.REB2010.submit()">
                                                    <%
                                                    {
 ...
 %>
                                            ...
                                            <td align="left"
                                                ...
                                                {
                                                %> Projectes:<br> <select name="projecteID" onchange="document.REB2010.submit()">
                                                    <%
 ...
 %>
                                            ...
                                            <td align="center"
                                                ...
                                                <a
                                                href="mostrarodt?<%=model.getRedirectUrlParams()%>&usuariID=<%=model.getUsuariId()%>"
                                                target="_blank"
                                                onmouseover="toolTip('ODT de Tasques de getSecurity().getFullNameOfUser(usuariID)', this)">
                                                    <img border="0" src="<c:url value="/img"/>/odt.gif">
                                            </a>
                                            ...
                                            <td align="center"
                                                ...
                                                %> <a href="<%=href%>" <%=target%> onmouseover="toolTip('ODT de Tasques de tot el personal', this)"> <img
                                                    border="0" src="<c:url value="/img"/>/odtmultiple.gif">
                                            </a>
                                            </td>
                                            <%
                                            }
                                            ...
                                            <td align="center"
                                                ...
                                                <a
                                                href="mostrarodt?<%=model.getRedirectUrlParams()%>&usuariID=<%=model.getUsuariId()%>&apaisat=true"
                                                target="_blank"
                                                onmouseover="toolTip('ODT de Tasques de getSecurity().getFullNameOfUser(usuariID)', this)">
                                                    <img border="0" src="<c:url value="/img"/>/odtapaisat.gif">
                                            </a>
                                            ...
                                            <td align="center"
                                                ...
                                                target = "target=\"_blank\"";
                                                %> <a href="<%=href%>" <%=target%> onmouseover="toolTip('ODT de Tasques de tot el personal', this)"> <img
                                                    border="0" src="<c:url value="/img"/>/odtapaisatmultiple.gif">
                                            </a>
                                            </td>
                                            <%
                                            }
 ...
 --%>
                                        ...
                                        <tr <%=(rowbgcolor == null) ? "" : ("bgcolor=\"#" + rowbgcolor + "\"")%>>
                                            ...
                                            <td align="center">
                                                <%
                                                if (!isCapDeSetmana) {
                                                %> <%-- <%=novaAccioURL%>&accioID=<%=Utils.ACCIO_NOVA_ENTRADA%> --%> <%--  <a href="javascript:alert('<%=msg%>')"> --%>
                                                <a href="<%=novaAccioURL%>&accioID=<%=Utils.ACCIO_NOVA_ENTRADA%>"> <img
                                                    onmouseover="toolTip('Afegir Nova Entrada', this)"
                                                    src="<c:url value="/img"/>/add.gif">
                                            </a> <%
 }
 %>
                                            </td>
                                                ...
                                                <table border=0 width="100%" height="100%" cellpadding="0"
                                                    ...
                                                    for (QueEsticFentItem qefi : llista) {
                                                    	...
                                                    	if (modificacions.size() == 0) {
                                                    		...
                                                    		&& !model.isMostrarEntradesAmagades()) {
                                                    	continue;
                                                    		}
                                                    	...
                                                    	bgColor = "bgcolor=\"#ffff00\"";
                                                    		...
                                                    		if (qefi.getModificacions().get(0).getAccio().getAccioID() != Utils.ACCIO_FESTIU
                                                    		&& qefi.getModificacions().get(0).getAccio().getAccioID() != Utils.ACCIO_VACANCES) {
                                                    ...
                                                    %>
                                                    <tr <%=bgColor%>>
                                                        <td <%=topBorder%> width="100%"><%=entradaStr%></td>
