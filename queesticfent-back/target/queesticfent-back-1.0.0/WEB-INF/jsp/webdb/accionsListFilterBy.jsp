...
<un:useConstants var="AccionsFields" className="org.fundaciobit.queesticfent.model.fields.AccionsFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccionsFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accions.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccionsFields.COLOR)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accions.color" var="color" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,AccionsFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="accions.descripcio" var="descripcio" />
