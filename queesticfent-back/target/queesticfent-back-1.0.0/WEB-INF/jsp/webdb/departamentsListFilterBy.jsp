...
<un:useConstants var="DepartamentsFields" className="org.fundaciobit.queesticfent.model.fields.DepartamentsFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DepartamentsFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="departaments.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DepartamentsFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="departaments.descripcio" var="descripcio" />
